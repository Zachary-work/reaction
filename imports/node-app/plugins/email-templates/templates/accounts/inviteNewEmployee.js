            ...
            <td align="center" valign="top"><table width="480" class="wrap1001" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    <td align="left" valign="top" style="font-family: 'Lato', sans-serif; font-size:13px; font-weight:bold; line-height:18px; color:#4d4d4d; letter-spacing: -0.5px;"><span style="font-weight:bold;">{{currentUserName}}</span> has invited you to join the company - <b>{{shopName}}</b> in AMAZ.</td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td width="223" height="40" align="center" valign="middle" bgcolor="#1999dd" style="font-family: 'Source Sans Pro', sans-serif; font-size:18px; font-weight:normal; line-height:18px;"><a href="{{url}}" style="text-decoration:none; color:#ffffff;">Accept Invitation</a></td>
                        <td>&nbsp;</td>
                      </tr>
                    </table></td>
                  </tr>
                  ...
                  <tr>
                    <td align="left" valign="top" style="font-family:Arial, Helvetica, sans-serif; font-size:12px; font-weight:normal; line-height:17px;">You received this email because you were invited to join a company - {{shopName}} in AMAZ platform. Questions or suggestions? Email us at <a href="mailto:{{contactEmail}}" style="text-decoration:none; color:#1e98d5;">{{contactEmail}}</a></td>
                  </tr>
                  <!-- Begin Social Icons -->
